...
//@interface FelicidadesObject : NSObject
//@end

@interface FelicidadesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FelicidadesObject class]])
		{
			for (NSString *key in [[(FelicidadesObject*)o modules] allKeys])
			{
