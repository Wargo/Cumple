...
// in simulator we redefine to format for Felicidades Developer console
...
{\
	NSString * exceptionName = [@"org.felicidades." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.felicidades";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIFelicidadesNativeItemNone = -1, 
	UIFelicidadesNativeItemSpinner = -2,
	UIFelicidadesNativeItemProgressBar = -3,
	
	UIFelicidadesNativeItemSlider = -4,
	UIFelicidadesNativeItemSwitch = -5,
	UIFelicidadesNativeItemMultiButton = -6,
	UIFelicidadesNativeItemSegmented = -7,
	
	UIFelicidadesNativeItemTextView = -8,
	UIFelicidadesNativeItemTextField = -9,
	UIFelicidadesNativeItemSearchBar = -10,
	
	UIFelicidadesNativeItemPicker = -11,
	UIFelicidadesNativeItemDatePicker = -12,
	
	UIFelicidadesNativeItemInfoLight = -13,
	UIFelicidadesNativeItemInfoDark = -14,
	
	UIFelicidadesNativeItemDisclosure = -15,
	
	UIFelicidadesNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Felicidades instances of
