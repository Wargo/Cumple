...
@interface FelicidadesObject : KrollCoverageObject {
#else
@interface FelicidadesObject : KrollObject {
#endif
@private
...
extern NSString * Felicidades$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	FelicidadesObject *_felicidades;
	BOOL shutdown;
