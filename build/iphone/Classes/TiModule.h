...
/**
 The base class for all Felicidades modules
 */
...
/**
 Felicidades Platform calls this method on startup.
 */
-(void)startup;

/**
 Felicidades Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Felicidades Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Felicidades Platform calls this method on resume.
 @param sender The sender of the event.
 */
